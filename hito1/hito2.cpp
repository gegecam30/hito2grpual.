...
void MostrarInstrucciones() {
    ...
    Console::SetCursorPosition(34, 25);Console::Write("    COMPLETA TODOS LOS NIVELES recogiendo la basura y");
    Console::SetCursorPosition(34, 26);Console::Write("    conviértete en el HÉROE ECOLÓGICO del mundo.");
...
void MiniMenu() {
    ...
    Console::SetCursorPosition(86,14);Console::Write("4. Nivel 4");
    Console::SetCursorPosition(86,15);Console::Write("5. Nivel 5");
    Console::SetCursorPosition(86,16);Console::Write("0. Regresar");
    Console::SetCursorPosition(86,18);Console::Write("===========================");
    Console::SetCursorPosition(86,19);Console::Write("Seleccione un nivel ");
    Console::ResetColor();
}
void MostrarMenu() {
    Console::Clear();
...
void MostrarCreditos() {
    ...
    Console::SetCursorPosition(80, 12);Console::Write("-Jorge (Animador)");
    Console::SetCursorPosition(80, 13);Console::Write("-Paolo (Animador)");
    Console::SetCursorPosition(80, 14);Console::Write("-Johan (Programador)");
    Console::SetCursorPosition(80, 15);Console::Write("-Geremy (Programador)");
    Console::SetCursorPosition(80, 16);Console::Write("-Ryusei (Programador)");
    Console::SetCursorPosition(80, 18);Console::Write("=============================");
    Console::SetCursorPosition(80, 19);Console::Write("Presiona una tecla para volver al menu...");
    Console::ReadKey();
}
    ...
    do {
        ...
        case 1: 
            ...
            case 3:
                ...
                break;
            case 4:
                InicializarPersonaje4();
                EjecutarEscenario4(regresarAlMenu);
                break;
            case 5:
                InicializarPersonaje5();
                EjecutarEscenario5(regresarAlMenu);
                break;
            default:
                InicializarPersonaje1();
                EjecutarEscenario1(regresarAlMenu);
